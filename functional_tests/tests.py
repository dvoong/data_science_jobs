...
#         # She is invited to enter a to-item straight away
#         inputbox = self.browser.find_element_by_id('id_new_item')
#         self.assertEqual(
...
#         # When she hits enter, she is taken to a new URL, and now the page lists "1: Buy peacock feathers" as an item in a to-do list
...
#         ## We use a new browser session to make sure that no information of Edith's is coming from cookies etc
#         self.browser.quit()
#         self.browser = webdriver.Firefox()
